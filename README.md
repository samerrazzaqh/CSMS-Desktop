...
📺 You can watch the full project explanation on ImagesPrject Folder:  
🔗 **[Watch here](https://github.com/samerrazzaqh/CSMS-Desktop/tree/master/CSMS/ImageProject)**  


## 📌 Description  

This project is a hands-on **C# Form** implementation of an CSMS store, covering key concepts such as:  

- Building the **UI** entirely using **Form Desktop **.  
